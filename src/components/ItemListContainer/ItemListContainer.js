    ...
    return (
        ...
        <div className="container flex xl:grid xl:grid-cols-4 gap-6 pt-4 pb-16 items-start m-auto">
            ...
            <div className="col-span-3">
                ...
                {/* ordenamiento Final*/}
                    <button className="text-sm items-center w-44 px-4 py-3 border-gray-300  shadow-sm rounded focus:ring-primary focus:border-primary text-center  text-dark-blue xl:hidden relative bg-primary p-2 border" onClick={() => setSidebarOpen   (!isSidebarOpen)}
                    >
                    {isSidebarOpen ? 'Filtros':'Cerrar Filtros' }
                    </button>
                </div>
                {/* products grid */}
